...
def get_input_args():
    ...
    parser.add_argument("--arch", default="densenet121", choices=("vgg16", "densenet121", "resnet101"))
...
def train(arch, model, loaders, device, epochs, learning_rate):
    parameters = None
...
def main():
    ...
    #parsing args
    if args.epochs < 0:
        print("Epoch: Invalid epoch value")
        print("Must be greater than 0")
        return
        
    if args.hidden_units < 0:
        print("Epoch: Invalid number of hidden units given")
        print("Must be greater than 0")
        return
    ...
    model, optimizer = train(arch, model, loaders, device, epochs, learning_rate)
